                ...
                <form className="space-y-4">
                    <div className="flex space-x-4">
                        <div className='w-1/2 flex flex-col'>
                            ...
                            <input type="text" placeholder="Enter your full name" className="w-full bg-[#F9F9F9] text-sm h-[48px] text-[#AFAFAF] px-4 border-none rounded" />
                        </div>
                        <div className='w-1/2 flex flex-col'>
                            <label className='text-[#535353] text-sm mb-2'>Email</label>
                            <input type="email" placeholder="Enter  your email" className="w-full bg-[#F9F9F9] text-sm h-[48px] text-[#AFAFAF] px-4 border-none rounded" />
                        </div>
                    </div>
                    <div className="flex space-x-4">
                        <div className='w-1/2 flex flex-col'>
                            <label className='text-[#535353] text-sm mb-2'>Phone Number</label>
                            <input type="text" placeholder="Enter your phone number" className="w-full bg-[#F9F9F9] text-sm h-[48px] text-[#AFAFAF] px-4 border-none rounded" />
                        </div>
                        <div className='w-1/2 flex flex-col'>
                    ...
                    <div className='w-full flex flex-col'>
                        ...
                        <textarea placeholder="Tell us something..." className="w-full bg-[#F9F9F9] text-sm h-32 text-[#AFAFAF] px-4 py-3 border-none rounded"></textarea>
                    </div>
                    <button type="submit" className="bg-[#E09F1F] text-white py-3 px-28 rounded text-sm my-10">Send Message</button>
                </form>
            </div>
        </section>
    );
