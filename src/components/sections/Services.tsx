            ...
            <div className="container mx-auto px-4 2xl:max-w-[1800px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:mt-24 mt-12">
                    <section id='design' className="bg-[#F9F9F9] p-6 rounded-lg">
                        ...
                        <Link href="/services" className="flex items-center text-black hover:text-[#ae7c18] uppercase text-xs font-semibold 2xl:text-base">Know more <span className='text-xl ml-2'>→</span></Link>
                    </section>
                    ...
                    <section id='finishing' className="bg-[#1B4D77] p-6 rounded-lg">
                        ...
                        <Link href="/services" className="flex items-center text-[#E09F1F] hover:text-[#ae7c18] uppercase text-xs font-semibold 2xl:text-sm">Know more <span className='text-xl ml-2'>→</span></Link>
                    </section>
                    
                    <section id="furniture" className="bg-[#F9F9F9] p-6 rounded-lg 2xl:text-xl">
